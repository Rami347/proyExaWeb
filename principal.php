...
<!-- sección de contacto -->
            ...
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <ul class="location_icon">
                     <li><a href="https://www.google.com/maps/@-16.5838848,-68.1869312,14z?authuser=0&entry=ttu&g_ep=EgoyMDI0MDkxMS4wIKXMDSoASAFQAw%3D%3D"><i class="fa fa-map-marker" aria-hidden="true"></i></a><br> Ubicación</li>
   ...
   <script>
      // Este ejemplo agrega un marcador para indicar la posición de Bondi Beach en Sydney,
      //Australia.
      function initMap() {
